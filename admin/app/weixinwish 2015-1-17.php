...
class wechatCallbackapiTest
{
            ...
            case "subscribe":
				...
				if(count($result_arr) > 0){
					foreach($result_arr as $val){
						$content[] = array("Title"=>$val['title'], "Description"=>'', "PicUrl"=>$val['picurl'], "Url" =>$val['url'] . $object->FromUserName);
					}
				}
	...
	[\xe1-\xef][\x80-\xbf][\x80-\xbf]|\xf0[\x90-\xbf][\x80-\xbf]
    ...
    {   
		...
		if(count($content_text) == 0){
			$content = "您好，小倍感谢您关注倍全。 1、想知道如何送货、送货时间？请回复“送货”； 2、想了解加盟信息？请回复“加盟”； 3、想确定送货范围？请回复“范围”； 4、想知道付款方式？请回复“付款”； 5、想了解营业时间？请回复“营业”； 6、想查询您的订单？请回复“订单”； 7、想知道商品种类？请回复“商品”； 8、想拨打倍全客服？请回复“电话”； 9、想参与我们的活动？请回复“活动”； 10、想领取百元洗衣红包？请回复“红包”； 11、想加入倍全，月薪六千？请回复“应聘”； 12、想马上洗衣？请点击下方菜单“码上洗衣”，现在回复“洗衣”即可领取百元洗衣券哦~";
		}
		if(is_array($content)){
            if (isset($content[0])){
				$result = $this->transmitNews($object, $content);
