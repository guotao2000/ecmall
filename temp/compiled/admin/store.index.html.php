  ...
  <table width="100%" cellspacing="0" class="dataTable">
    ...
    <tr class="tatr1">
      ...
      <td><span ectype="order_by" fieldname="store_name">店铺名称</span></td>
       <td><span ectype="order_by" fieldname="clearsc">市价清零|批量市价</span></td>
      ...
      <?php endif; ?>
      <td class="handler" width="20">操作</td>
    </tr>
    <?php endif; ?>
...
?>
    <tr class="tatr2">
      ...
      <td><?php echo htmlspecialchars($this->_var['store']['store_name']); ?></td>
       <td><a href="/admin/index.php?app=store&act=clearsc&id=<?php echo $this->_var['store']['store_id']; ?>" >市价清零</a>|<a href="/admin/index.php?app=store&act=prosc&id=<?php echo $this->_var['store']['store_id']; ?>" >批量市价</a></td>
