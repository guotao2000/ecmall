  ...
  <form method="post" enctype="multipart/form-data" id="user_form">
    <table class="infoTable">
      ...
      <tr>
       ...
       <tr>
        <th class="paddingT15"> 本人推荐号:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="uin" type="text" id="uin" value="<?php echo htmlspecialchars($this->_var['user']['uin']); ?>" />        </td>
      </tr>
      <tr>
        <th class="paddingT15"> 推荐人号:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="parentid" type="text" id="parentid" value="<?php echo htmlspecialchars($this->_var['user']['parentid']); ?>" />        </td>
      </tr>
      <!--<tr>
	  ...
	  <tr>
        <th class="paddingT15"> 管理店铺编号:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="m_storeid" type="text" id="m_storeid" value="<?php echo htmlspecialchars($this->_var['user']['m_storeid']); ?>" />        </td>
      </tr>
