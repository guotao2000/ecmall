...
?>
        <tr class="tatr2">
            ...
            <td><a href="index.php?app=file&amp;act=edit&amp;id=<?php echo $this->_var['upload']['id']; ?>">编辑</a>｜<a href="index.php?app=file&amp;act=drop&amp;id=<?php echo $this->_var['upload']['id']; ?>">删除</a>|
            <a href="<?php echo $this->_var['upload']['filename']; ?>">预览</a></td>
        </tr>
        <?php endforeach; else: ?>
        <tr class="no_data">
