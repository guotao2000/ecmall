...
<div id="rightTop">
    <p><b>订单详情</b><b style="margin-left:100px;"><a href="index.php?app=order_print&order_id=<?php echo $_GET['id']; ?>" target="_blank">打印订单</a></b></p>
</div>
<div class="info">
    <div class="demand">
    </div>
    <div class="order_form">
        ...
        <ul>
            ...
            <li><b>订单状态:</b> <?php if ($this->_var['order']['status'] == 11): ?>等待买家付款<?php endif; ?>
    ...
    <div class="order_form">
        ...
        <h2>订单信息</h2>
        <ul>
            <li><b>买家名称 :</b> <?php if ($this->_var['order']['from_weixin'] == 1): ?><?php echo $this->_var['order']['wx_nickname']; ?><?php else: ?><?php echo htmlspecialchars($this->_var['order']['buyer_name']); ?><?php endif; ?></li>
