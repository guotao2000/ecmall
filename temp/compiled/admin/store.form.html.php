...
$(function(){
    regionInit("region");
    psregionInit("div_pei");
	$("#aids").change(function(){
		if(this.checked){this.val(1); alert(1);}
		else{this.val(0);alert(0);}
    ...
    <table class="infoTable">
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5" ><div id="region">
            ...
            <input type="button" value="编辑" class="edit_region" onclick="newregionEdit(this,<?php echo $this->_var['store']['region_id']; ?>);" />
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5">
         <input class="infoTableInput" name="s_long" type="text" id="s_long" value="<?php echo htmlspecialchars($this->_var['store']['s_long']); ?>"/>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5">
         <input class="infoTableInput" name="s_lat" type="text" id="s_lat" value="<?php echo htmlspecialchars($this->_var['store']['s_lat']); ?>"/>
        </td>
      </tr>

       <tr>
        <th class="paddingT15">总店铺权限:</th>
        <td class="paddingT15 wordSpacing5">
         <?php echo $this->html_radios(array('name'=>'aids','options'=>$this->_var['aids'],'checked'=>$this->_var['store']['power_coupon'])); ?>
        </td>
      </tr>
     <tr>
        <th class="paddingT15">父亲店铺:</th>
        <td class="paddingT15 wordSpacing5">
         <input class="infoTableInput" name="parentid" type="text" id="parentid" value="<?php echo htmlspecialchars($this->_var['store']['parentid']); ?>"/>
        </td>
      </tr>
      <tr>
