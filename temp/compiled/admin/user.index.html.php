...
?>
    <tr class="tatr2">
      ...
      <td><?php if ($this->_var['user']['wx_headimgurl']): ?><img src="<?php echo htmlspecialchars($this->_var['user']['wx_headimgurl']); ?> " width="80px" height="80px" /><?php else: ?>暂无图片<?php endif; ?></td>
      ...
      <td><?php echo local_date("Y-m-d H:i:s",$this->_var['user']['reg_time']); ?></td>
      <td><?php if ($this->_var['user']['last_login']): ?><?php echo local_date("Y-m-d H:i:s",$this->_var['user']['last_login']); ?><?php endif; ?><br />
        <?php echo $this->_var['user']['last_ip']; ?></td>
      <td><?php echo $this->_var['user']['logins']; ?></td>
       <td><?php echo $this->_var['user']['uin']; ?></td>
        <td><?php echo $this->_var['user']['parentid']; ?></td>
		<td><?php if ($this->_var['user']['from_weixin'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
