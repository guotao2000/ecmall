    ...
    <form method="post" enctype="multipart/form-data" id="gcategory_form">
        <table class="infoTable">
			...
			<tr>
                ...
                <td class="paddingT15 wordSpacing5">
                    <input type="file" name="cate_picurl" />
                    <input type="hidden" name="cate_picurl_hide" value="<?php echo htmlspecialchars($this->_var['gcategory']['cate_picurl']); ?>" />
                    <label class="field_notice">上传图片类型：.jpg,.png,.gif,.jpeg，图片不大于2M</label>
                </td>
            </tr>
            <tr>
                <th class="paddingT15">
