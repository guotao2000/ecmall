...
<div class="content">
    ...
    <div id="right"> <?php echo $this->fetch('member.submenu.html'); ?>
        <div class="wrap">
            <div class="eject_btn_two eject_pos1" title="红包登记"><b class="ico3" ectype="dialog" dialog_title="红包登记" dialog_id="my_coupon_bind" dialog_width="480" uri="index.php?app=my_coupon&act=bind">红包登记</b></div>
