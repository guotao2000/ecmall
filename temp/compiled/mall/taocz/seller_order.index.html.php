...
?>
                    <tr class="color2">
                        ...
                        <td class="align2"><?php if ($this->_var['order']['from_weixin'] == 1): ?><?php echo $this->_var['order']['wx_nickname']; ?><?php else: ?><?php echo htmlspecialchars($this->_var['order']['buyer_name']); ?><?php endif; ?></td>
                        ...
                        <td class="align2"><?php echo $this->_var['order']['payment_name']; ?></td>
                        ...
                        <?php if ($this->_var['order']['evaluation_status']): ?>,&nbsp;已评价<?php endif; ?></span></td>
                    </tr>
                    <tr class="line_bottom">
                        ...
                        <input type="button" value="发货" class="btn1" ectype="dialog" dialog_title="发货" dialog_id="seller_order_shipped" uri="index.php?app=seller_order&amp;act=shipped&amp;order_id=<?php echo $this->_var['order']['order_id']; ?>&ajax"  dialog_width="400" id="Button2" />
                        
                        
                        
                        <input type="button" value="收到货款" class="btn" ectype="dialog" dialog_id="seller_order_received_pay" dialog_width="400" uri="index.php?app=seller_order&amp;act=received_pay&amp;order_id=<?php echo $this->_var['order']['order_id']; ?>&ajax" dialog_title="收到货款" id="order<?php echo $this->_var['order']['order_id']; ?>_action_received_pay" />
                        

                        
                        <input type="button" value="取消订单" class="btn1" ectype="dialog" uri="index.php?app=seller_order&amp;act=cancel_order&order_id=<?php echo $this->_var['order']['order_id']; ?>&ajax" dialog_title="取消订单" dialog_id="seller_order_cancel_order" dialog_width="400" id="order<?php echo $this->_var['order']['order_id']; ?>_action_cancel" />
                        
                          
                        <input type="button" value="退货申请" class="btn1" ectype="dialog" uri="index.php?app=seller_order&amp;act=thsq&oid=<?php echo $this->_var['order']['order_id']; ?>&ajax" dialog_title="退货申请" dialog_id="seller_order_thsq" dialog_width="400" id="order<?php echo $this->_var['order']['order_id']; ?>_thsq" />
                        
                          
                        <input type="button" value="退货审核" class="btn1" ectype="dialog" uri="index.php?app=seller_order&amp;act=thsh&oid=<?php echo $this->_var['order']['order_id']; ?>&ajax" dialog_title="退货审核" dialog_id="seller_order_thsh" dialog_width="400" id="order<?php echo $this->_var['order']['order_id']; ?>_thsh" />
                        
                          
                        <input type="button" value="退货成功" class="btn1" ectype="dialog" uri="index.php?app=seller_order&amp;act=thcg&oid=<?php echo $this->_var['order']['order_id']; ?>&ajax" dialog_title="退货成功" dialog_id="seller_order_thcg" dialog_width="400" id="order<?php echo $this->_var['order']['order_id']; ?>_thcg" />
                        
                          
                        <input type="button" value="退货失败" class="btn1" ectype="dialog" uri="index.php?app=seller_order&amp;act=thsb&oid=<?php echo $this->_var['order']['order_id']; ?>&ajax" dialog_title="退货失败" dialog_id="seller_order_thsb" dialog_width="400" id="order<?php echo $this->_var['order']['order_id']; ?>_thsb" />
                        
                                              
                        
                        <a class="btn1" href="<?php echo url('app=seller_order&act=view&order_id=' . $this->_var['order']['order_id']. ''); ?>" target="_blank">查看订单</a>
                         <a class="btn1" href="<?php echo url('app=seller_order&act=edit&order_id=' . $this->_var['order']['order_id']. ''); ?>" target="_blank">编辑订单</a>
                       </div> </td>
                    </tr>
                    <?php endforeach; else: ?>
...
<input type="hidden" value=<?php echo $this->_var['store_id']; ?> id="store_id"/>
