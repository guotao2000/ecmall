    ...
    <div id="right"> <?php echo $this->fetch('member.submenu.html'); ?>
        <div class="wrap">
            <div class="public table">
                <table>
                    <div class="eject_btn_two eject_pos1" title="添加"><b class="ico3" ectype="dialog" dialog_title="添加" dialog_id="coupon_add" dialog_width="480" uri="index.php?app=coupon&amp;act=add">新增红包</b></div>
...
<script type="text/javascript">
    function generate(goodid) {
        var n = prompt('请填写生成红包数量', '');
        if (n.length > 0) {
            var url = 'index.php?app=coupon&act=bqcoupon&store_id=<?php echo $this->_var['store_id']; ?>&count=' + n + '&coupon_id=' + goodid;
