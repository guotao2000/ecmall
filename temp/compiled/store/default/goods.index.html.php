...
<div id="content">
    ...
    <div id="right">
        <?php if ($_GET['app'] == buyer_seckill): ?>
		<?php echo $this->fetch('seckill.goodsinfo.html'); ?>
		<?php else: ?>
        ...
        <ul class="user_menu">
            ...
            <li><a class="active" href="<?php if ($_GET['app'] == buyer_seckill): ?><?php echo url('app=buyer_seckill&act=seckill_goods&id=' . $this->_var['goods']['goods_id']. '&sid=' . $_GET['sid']. ''); ?>#module<?php else: ?><?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>#module<?php endif; ?>"><span>商品详情</span></a></li>
            <li><a class="normal" href="<?php if ($_GET['app'] == buyer_seckill): ?><?php echo url('app=buyer_seckill&act=comments&id=' . $this->_var['goods']['goods_id']. '&sid=' . $_GET['sid']. ''); ?>#module<?php else: ?><?php echo url('app=goods&act=comments&id=' . $this->_var['goods']['goods_id']. '&sid=' . $_GET['sid']. ''); ?>#module<?php endif; ?>"><span>商品评论</span></a></li>
            <li><a class="normal" href="<?php if ($_GET['app'] == buyer_seckill): ?><?php echo url('app=buyer_seckill&act=saleslog&id=' . $this->_var['goods']['goods_id']. '&sid=' . $_GET['sid']. ''); ?>#module<?php else: ?><?php echo url('app=goods&act=saleslog&id=' . $this->_var['goods']['goods_id']. '&sid=' . $_GET['sid']. ''); ?>#module<?php endif; ?>"><span>销售记录</span></a></li>
            <li><a class="normal" href="<?php if ($_GET['app'] == buyer_seckill): ?><?php echo url('app=buyer_seckill&act=qa&id=' . $this->_var['goods']['goods_id']. '&sid=' . $_GET['sid']. ''); ?>#module<?php else: ?><?php echo url('app=goods&act=qa&id=' . $this->_var['goods']['goods_id']. ''); ?>#module<?php endif; ?>"><span>产品咨询</span></a></li>
        </ul>
