...
<div class="com-content">
  ...
  <div class="com-header-area" id="js-com-header-area">
		  ...
		  <dfn></dfn>
          <span class="bq_header_title" style="padding-left:0px;">登录成功</span>
   ...
   <div class="page-role cart_empty-page">
      <div class="pxui-area">
           ...
           <div class="cart_empty-top">
              <p>
               <span class="cart_empty-topicon"></span>客官：恭喜您成功登录倍全商城~~
              </p>
           </div>
        ...
        <div class="cart_empty-info">
             ...
             <div class="login_success-btn">
                 <a type="button"  href="<?php echo url('app=member'); ?>"  >会员中心</a>
             </div>
        </div>        
       </div>
      </div>
