...
<div class="page-role good-page">	
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo $this->res_base . "/" . 'bqmart/template/css/order/order.css'; ?>" >	
     ...
     <div class="pxui-area">
         ...
         <div class="new-ct shouhuo">
            ...
            <div class="info border-b-none pd">
        	  <div class="tbl-type">
                ...
                <input  style="height:auto; width:95%;" type="text" class="new-input" name="address_detail" id="address_detail" value="<?php echo $this->_var['region_name']; ?>"/>
                </span></span>
               </div>
           </div>
    	...
    	<input type="submit" style="background:#FB8C08;border:none;border-radius: 6px;color: #fff;
