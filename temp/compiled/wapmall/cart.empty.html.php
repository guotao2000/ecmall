...
<div class="com-content" style="box-shadow:none;">
  ...
  border-bottom: 2px solid #ccc;color:#000;">
		  ...
		  <dfn></dfn>
          <span class="bq_header_title" style="padding-left:0px;">购物车为空</span>
   ...
   <div class="page-role cart_empty-page">
      <div class="pxui-area">
           ...
           <div class="cart_empty-top">
              <p>
               <span class="cart_empty-topicon"></span>客官您购物车是空的，快去购物~~
              </p>
           </div>
        ...
        <div class="cart_empty-info">
             <div class="cart_empty-img">
                <img src="themes/bqmart/template/images/cart/bq_cart_empty.png" > </div>
             <p>
             您的购物车是空的，查看最新活动！
             </p>
             <div class="cart_empty-btn">
                 <a type="button"  href="/index.php?app=cartyxw">去 逛 逛</a>
             </div>
        </div>        
       </div>
      </div>
