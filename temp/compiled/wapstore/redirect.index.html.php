...
<div class="com-content">
  ...
  <div class="com-header-area bq_index-header" id="js-com-header-area">
		  ...
		  <dfn></dfn>
          <span class="bq_header_title" style="padding-left:0px;"><?php echo $this->_var['store']['store_name']; ?></span>
        ...
        <div class="bq_index-box" id="js-attrs-title">
          ...
          <div class="new-srch-lst" id="shelper" style="position: absolute; top: 2em; left: 3.28em; z-index: 10; width: 404.2px; display: none;"></div>
           ...
           <div  class="bq_index-info">
			  ...
			  <div class="bq_bkad" style="padding:10px 5px 0px;">
              ...
              <div class="bq_index-infobox">
                 <ul style="padding-top:0px;">
                    <li>
					 ...
					 <a href="/index.php?app=zhuanti&id=16&store_id=<?php echo $_GET['id']; ?>">
              ...
              <div class="bq_index-infobox">
                 <ul>
                    <li>
					 ...
					 <a href="http://wap.bqmart.cn/index.php?app=zhuanti&id=12&uin=178&act=index&state=4&openid=">
                     <div class="indx_box-r one" style="background:#D0003E;">
                         <span class="indx_box-icon4"></span>
                         <p  style=" line-height:48px;">蛋糕鲜花</p>
                     </div>
                     </a>
              ...
              <div class="bq_index-infobox">
                 <ul>
                    <li>
                     ...
                     <a href="http://wap.bqmart.cn/index.php?app=zhuanti&id=11">
                     ...
                     <div class="indx_box-r" style="background:#FF8000;">
			 ...
			 <!--年货广告位开始
             <div class="bq_bkad" style="margin-top:20px;">
               <a href="http://wap.bqmart.cn/index.php?app=zhuanti&id=11"><img width="100%" src="themes/bqmart/images/nh_banner.jpg"></a>
             </div>-->
