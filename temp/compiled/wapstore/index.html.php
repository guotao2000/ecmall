...
<div class="com-content">
  ...
  <div class="com-header-area bq_index-header" id="js-com-header-area">
          <a href="<?php echo url('app=default'); ?>" class="bq-header-libiao"></a>
		  <dfn></dfn>
                 ...
                 <ul>
                    <li>
                     ...
                     <div class="indx_box-l one" style="background:#6bb61d">
                      ...
                      <a href="<?php echo url('app=search&cate_id=64&id=' . $_GET['id']. ''); ?>" onClick="dianji()">
              ...
              <div class="bq_index-infobox">
                 <ul>
                    <li>
                     ...
                     <div class="indx_box-l" style="background:#5134A4">
