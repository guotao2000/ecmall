  ...
  <body>
    <div class="com-content">
        ...
        <div class="com-content-area" id="js-com-content-area" style=" margin:12px 2px;">
          ...
          <a href="<?php echo url('app=my_favorite&type=store'); ?>" <?php if ($_GET['type'] == 'store'): ?> class="selected" style="border-radius: 0 8px 8px 0;" <?php endif; ?>>逛过的店铺</a>
          </div>
...
?>
                 <li class="clearfix">
                    <a href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. ''); ?>" style=" border-right:none; float:none; margin-left:0px;"><img src="<?php echo $this->_var['store']['store_logo']; ?>"></a>
                   <div class="zxProInfo" style="line-height:22px;" >
                      <p class="proName" style="line-height:22px; margin-bottom:5px;"><a href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. ''); ?>" style=" border-right:none; float:none; margin-left:0px; border-bottom:none;"><?php echo htmlspecialchars($this->_var['store']['store_name']); ?></a></p>
                      <span class="proPrice" style="display:block;">距离：2.0 Km</span>                 <span style="margin-left:20px; font-size:14px; display:block; margin-top:3px;">商品：<?php echo htmlspecialchars($this->_var['store']['goods_num']); ?>+</span>
                      <a href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. ''); ?>" class="guangguang" style="border-right:none;">去逛逛</a>
                  </div>
                 </li>
                 <?php endforeach; else: ?>
                 <li>没有符合条件的店铺</li>
