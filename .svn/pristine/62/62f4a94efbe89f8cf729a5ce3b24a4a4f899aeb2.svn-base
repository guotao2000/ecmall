...
<meta name="copyright" content="ShopEx Inch. All Rights Reserved" />
...
<div id="site-nav" class="w-full">
   <div class="shoptop w clearfix">
      <div class="login_info">
         ...
         <a href="index.php?app=third_login&act=qq"><img style="vertical-align:middle" src="/static/images/login_qq.png" /></a>
         <?php else: ?>
