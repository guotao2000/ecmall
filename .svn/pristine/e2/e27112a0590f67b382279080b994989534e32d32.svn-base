...
<form name="card_form" onSubmit="return card();" action="index.php?app=my_money&act=card_cz" method="post" target="_blank">
				  ...
				  <br>注：如果您通过线下汇款或活动赚金，请联系管理员索取。(QQ:<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=540616918&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:540616918:41 &r=0.4908261565915385" alt="为您服务" title="为您服务"></a> 热线:540616918)<br>
