...
class KXClient{
	...
	public $client_id = "9990838055091fb08467c7e0b8696ff8"; //api key
	public $client_secret = "17ed3aedaaaed9d805a4ea9df9d2ea16"; //app secret
	public $redirect_uri = "http://www.513cc.com/includes/third/kaixin_api/redirect.php";//回调地址，所在域名必须与开发者注册应用时所提供的网站根域名列表或应用的站点地址（如果根域名列表没填写）的域名相匹配
