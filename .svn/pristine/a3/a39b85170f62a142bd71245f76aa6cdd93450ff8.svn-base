...
INSERT INTO ecm_address ( `addr_id`, `user_id`, `consignee`, `region_id`, `region_name`, `address`, `zipcode`, `phone_tel`, `phone_mob` ) VALUES  ('5','17','yafa','18','中国	北京	北京	平谷区','fafaf','','15668333567','');
INSERT INTO ecm_address ( `addr_id`, `user_id`, `consignee`, `region_id`, `region_name`, `address`, `zipcode`, `phone_tel`, `phone_mob` ) VALUES  ('6','16','fasfds','2850','中国	天津	天津	河北区','fdsfds','','15888999568','15888999568');
...
INSERT INTO ecm_cart ( `rec_id`, `user_id`, `session_id`, `store_id`, `goods_id`, `sku`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `remains`, `goods_image`, `is_sale`, `cuxiao_ids` ) VALUES  ('11','9','35f4d35f4ebd383337d1bf5441412853','2','92',null,'中兴（ZTE）U960s3 3G手机 TD-SCDMA/GSM','92','','495.00','1',null,'data/files/store_2/goods_3/small_201312262303231812.jpg',null,null);
INSERT INTO ecm_cart ( `rec_id`, `user_id`, `session_id`, `store_id`, `goods_id`, `sku`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `remains`, `goods_image`, `is_sale`, `cuxiao_ids` ) VALUES  ('12','5','ea4b42ae429d65e0a87eb5a6d6969f59','2','96',null,'诺基亚（NOKIA） Lumia 720T 3G手机 TD-SCDMA/GSM','96','','1749.00','1',null,'data/files/store_2/goods_170/small_201312262306104597.jpg',null,null);
INSERT INTO ecm_cart ( `rec_id`, `user_id`, `session_id`, `store_id`, `goods_id`, `sku`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `remains`, `goods_image`, `is_sale`, `cuxiao_ids` ) VALUES  ('31','12','cb7dc47a8668d1854e448ca99dff25fd','2','97','','三星（SAMSUNG）I8558 3G手机 TD-SCDMA/GSM 双卡双待','97','','1549.00','2','1','data/files/store_2/goods_27/small_201312262307078496.jpg','0','1,');
INSERT INTO ecm_cart ( `rec_id`, `user_id`, `session_id`, `store_id`, `goods_id`, `sku`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `remains`, `goods_image`, `is_sale`, `cuxiao_ids` ) VALUES  ('30','12','cb7dc47a8668d1854e448ca99dff25fd','2','101','695072785132','测试商品','104','','10.00','2','0','data/files/store_2/goods_106/small_201412121551463018.jpg','0','1,');
...
CREATE TABLE ecm_coupon (
  ...
  stores_allow text COMMENT '允许使用的店铺',
  cate_noallow text COMMENT '禁止使用的类型',
  PRIMARY KEY (coupon_id),
  KEY store_id (store_id)
) ENGINE=MyISAM;
INSERT INTO ecm_coupon ( `coupon_id`, `store_id`, `coupon_name`, `coupon_value`, `use_times`, `start_time`, `end_time`, `min_amount`, `if_issue`, `stores_allow`, `cate_noallow` ) VALUES  ('9','2','杨秀伟定制','10.00','1','1418198400','1420012799','5.00','1','2',',13,3');
INSERT INTO ecm_coupon ( `coupon_id`, `store_id`, `coupon_name`, `coupon_value`, `use_times`, `start_time`, `end_time`, `min_amount`, `if_issue`, `stores_allow`, `cate_noallow` ) VALUES  ('10','2','测试','20.00','1','1418198400','1419926399','5.00','1','2',',4');
DROP TABLE IF EXISTS ecm_coupon_record;
CREATE TABLE ecm_coupon_record (
  cr_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '编号，主键 自增',
  trade_sn varchar(255) NOT NULL COMMENT '交易流水号',
  user_id int(11) unsigned NOT NULL COMMENT '用户编号',
  trade_time int(10) unsigned NOT NULL COMMENT '交易时间',
  expense_money decimal(10,2) NOT NULL COMMENT '消费金额',
  coupon_money decimal(10,2) NOT NULL COMMENT '红包金额',
  used_money decimal(10,2) NOT NULL COMMENT '冲抵金额',
  coupon_sn varchar(255) NOT NULL COMMENT '红包编号',
  PRIMARY KEY (cr_id)
) ENGINE=MyISAM;
...
INSERT INTO ecm_coupon_sn ( `coupon_sn`, `coupon_id`, `remain_times` ) VALUES  ('000000404539','9','1');
INSERT INTO ecm_coupon_sn ( `coupon_sn`, `coupon_id`, `remain_times` ) VALUES  ('000000502913','10','1');
INSERT INTO ecm_coupon_sn ( `coupon_sn`, `coupon_id`, `remain_times` ) VALUES  ('000000606542','9','1');
INSERT INTO ecm_coupon_sn ( `coupon_sn`, `coupon_id`, `remain_times` ) VALUES  ('000000612070','9','1');
DROP TABLE IF EXISTS ecm_discount_promotion;
CREATE TABLE ecm_discount_promotion (
  discount_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '折扣促销编号',
  discount_name varchar(500) NOT NULL COMMENT '折扣促销名称',
  start_time int(10) unsigned NOT NULL COMMENT '折扣开始时间',
  end_time int(10) unsigned NOT NULL COMMENT '折扣结束时间',
  store_id int(11) unsigned NOT NULL COMMENT '执行店铺',
  loop_num int(11) unsigned NOT NULL COMMENT '循环次数',
  discount_state tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '折扣促销状态',
  pattern_a int(11) unsigned NOT NULL COMMENT '组合A',
  `condition` varchar(500) NOT NULL COMMENT '满足条件',
  exec_type tinyint(1) unsigned NOT NULL COMMENT '执行依据 0：金额 1：数量',
  pattern_b int(11) unsigned NOT NULL COMMENT '组合B',
  weight_factor int(11) unsigned NOT NULL COMMENT '权重',
  operate_time int(10) unsigned NOT NULL COMMENT '操作时间',
  operate_person varchar(255) NOT NULL COMMENT '操作人',
  PRIMARY KEY (discount_id)
) ENGINE=MyISAM;
INSERT INTO ecm_discount_promotion ( `discount_id`, `discount_name`, `start_time`, `end_time`, `store_id`, `loop_num`, `discount_state`, `pattern_a`, `condition`, `exec_type`, `pattern_b`, `weight_factor`, `operate_time`, `operate_person` ) VALUES  ('1','测试促销1','1418198400','1420012799','2','999','2','0','','0','0','10','0','');
...
INSERT INTO ecm_goods ( `goods_id`, `store_id`, `type`, `goods_name`, `description`, `cate_id`, `cate_name`, `brand`, `spec_qty`, `spec_name_1`, `spec_name_2`, `if_show`, `if_seckill`, `closed`, `close_reason`, `add_time`, `last_update`, `default_spec`, `default_image`, `recommended`, `cate_id_1`, `cate_id_2`, `cate_id_3`, `cate_id_4`, `price`, `tags`, `cuxiao_ids` ) VALUES  ('1','2','material','合家欢 新鲜西红柿 酸酸甜甜 凌晨采购 全程冷链','','19','网上菜场、果蔬生鲜	水果	苹果','','0','','','1','0','0',null,'1388033366','1388033366','1','data/files/store_2/goods_110/small_201312262048304586.jpg','1','1','14','19','0','8.00','',null);
INSERT INTO ecm_goods ( `goods_id`, `store_id`, `type`, `goods_name`, `description`, `cate_id`, `cate_name`, `brand`, `spec_qty`, `spec_name_1`, `spec_name_2`, `if_show`, `if_seckill`, `closed`, `close_reason`, `add_time`, `last_update`, `default_spec`, `default_image`, `recommended`, `cate_id_1`, `cate_id_2`, `cate_id_3`, `cate_id_4`, `price`, `tags`, `cuxiao_ids` ) VALUES  ('2','2','material','袋装水果','','19','网上菜场、果蔬生鲜	水果	苹果','','0','','','1','0','0',null,'1388033524','1388033524','2','data/files/store_2/goods_198/small_201312262049586818.jpg','1','1','14','19','0','100.00','',null);
INSERT INTO ecm_goods ( `goods_id`, `store_id`, `type`, `goods_name`, `description`, `cate_id`, `cate_name`, `brand`, `spec_qty`, `spec_name_1`, `spec_name_2`, `if_show`, `if_seckill`, `closed`, `close_reason`, `add_time`, `last_update`, `default_spec`, `default_image`, `recommended`, `cate_id_1`, `cate_id_2`, `cate_id_3`, `cate_id_4`, `price`, `tags`, `cuxiao_ids` ) VALUES  
INSERT INTO ecm_goods ( `goods_id`, `store_id`, `type`, `goods_name`, `description`, `cate_id`, `cate_name`, `brand`, `spec_qty`, `spec_name_1`, `spec_name_2`, `if_show`, `if_seckill`, `closed`, `close_reason`, `add_time`, `last_update`, `default_spec`, `default_image`, `recommended`, `cate_id_1`, `cate_id_2`, `cate_id_3`, `cate_id_4`, `price`, `tags`, `cuxiao_ids` ) VALUES  ('101','2','material','测试商品','','20','网上菜场、果蔬生鲜	水果	葡萄','杨秀伟品牌','0','','','1','0','0',null,'1418341914','1418405865','104','data/files/store_2/goods_106/small_201412121551463018.jpg','1','1','14','20','0','10.00',',杨秀伟标签,','1,');
...
INSERT INTO ecm_goods_image ( `image_id`, `goods_id`, `image_url`, `thumbnail`, `sort_order`, `file_id` ) VALUES  ('109','101','data/files/store_2/goods_106/201412121551463018.jpg','data/files/store_2/goods_106/small_201412121551463018.jpg','1','110');
...
INSERT INTO ecm_goods_spec ( `spec_id`, `goods_id`, `spec_1`, `spec_2`, `color_rgb`, `price`, `stock`, `sku` ) VALUES  ('98','98','','','','1588.00','81','');
...
INSERT INTO ecm_goods_spec ( `spec_id`, `goods_id`, `spec_1`, `spec_2`, `color_rgb`, `price`, `stock`, `sku` ) VALUES  ('104','101','','','','10.00','100','695072785132');
...
INSERT INTO ecm_goods_statistics ( `goods_id`, `views`, `collects`, `carts`, `orders`, `sales`, `comments` ) VALUES  ('15','2','0','1','0','0','0');
...
INSERT INTO ecm_goods_statistics ( `goods_id`, `views`, `collects`, `carts`, `orders`, `sales`, `comments` ) VALUES  ('95','1','0','1','1','0','0');
INSERT INTO ecm_goods_statistics ( `goods_id`, `views`, `collects`, `carts`, `orders`, `sales`, `comments` ) VALUES  ('96','7','0','1','0','0','0');
INSERT INTO ecm_goods_statistics ( `goods_id`, `views`, `collects`, `carts`, `orders`, `sales`, `comments` ) VALUES  ('97','9','0','4','1','0','0');
INSERT INTO ecm_goods_statistics ( `goods_id`, `views`, `collects`, `carts`, `orders`, `sales`, `comments` ) VALUES  ('98','38','0','25','23','0','0');
INSERT INTO ecm_goods_statistics ( `goods_id`, `views`, `collects`, `carts`, `orders`, `sales`, `comments` ) VALUES  ('100','11','0','3','1','0','0');
INSERT INTO ecm_goods_statistics ( `goods_id`, `views`, `collects`, `carts`, `orders`, `sales`, `comments` ) VALUES  ('101','18','0','12','0','0','0');
...
DROP TABLE IF EXISTS ecm_integral_record;
CREATE TABLE ecm_integral_record (
  ir_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '编号，主键 自增',
  trade_sn varchar(255) NOT NULL COMMENT '交易流水号',
  user_id int(11) unsigned NOT NULL COMMENT '用户编号',
  trade_time int(10) unsigned NOT NULL COMMENT '交易时间',
  used_integral int(11) unsigned NOT NULL COMMENT '使用积分',
  PRIMARY KEY (ir_id)
) ENGINE=MyISAM;
...
DROP TABLE IF EXISTS ecm_kuaixun_promotion;
CREATE TABLE ecm_kuaixun_promotion (
  kuaixun_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '快讯促销编号',
  kuaixun_name varchar(500) NOT NULL COMMENT '快讯促销名称',
  goods_id int(11) unsigned NOT NULL COMMENT '商品编号',
  goods_sn varchar(255) NOT NULL COMMENT '商品条码',
  goods_name varchar(500) NOT NULL COMMENT '商品名称',
  kuaixun_price decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '快讯价格',
  start_time int(10) unsigned NOT NULL COMMENT '快讯开始时间',
  end_time int(10) unsigned NOT NULL COMMENT '快讯结束时间',
  store_ids varchar(500) NOT NULL COMMENT '执行店铺，可以为多店铺',
  add_time int(10) unsigned NOT NULL COMMENT '录入时间',
  kuaixun_state tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '促销状态',
  operate_person varchar(255) NOT NULL COMMENT '操作人',
  PRIMARY KEY (kuaixun_id)
) ENGINE=MyISAM;
INSERT INTO ecm_kuaixun_promotion ( `kuaixun_id`, `kuaixun_name`, `goods_id`, `goods_sn`, `goods_name`, `kuaixun_price`, `start_time`, `end_time`, `store_ids`, `add_time`, `kuaixun_state`, `operate_person` ) VALUES  ('2','测试名称','0','','','0.00','1419007325','1419698528','2,3,4,5','1418628916','1','马凯');
INSERT INTO ecm_kuaixun_promotion ( `kuaixun_id`, `kuaixun_name`, `goods_id`, `goods_sn`, `goods_name`, `kuaixun_price`, `start_time`, `end_time`, `store_ids`, `add_time`, `kuaixun_state`, `operate_person` ) VALUES  ('3','行东的俄方公司','94','','华为（Huawei）T8951（G510）3G手机 TD-SCDMA/GSM','0.00','1419007325','1419698528','3,4','1418646549','2','好大哥');
INSERT INTO ecm_kuaixun_promotion ( `kuaixun_id`, `kuaixun_name`, `goods_id`, `goods_sn`, `goods_name`, `kuaixun_price`, `start_time`, `end_time`, `store_ids`, `add_time`, `kuaixun_state`, `operate_person` ) VALUES  ('4','快乐的','0','','','0.00','1419007325','1419698528','1,2,3','1418646606','1','卡卡开发');
INSERT INTO ecm_kuaixun_promotion ( `kuaixun_id`, `kuaixun_name`, `goods_id`, `goods_sn`, `goods_name`, `kuaixun_price`, `start_time`, `end_time`, `store_ids`, `add_time`, `kuaixun_state`, `operate_person` ) VALUES  ('5','开来的东西大法师','0','','','0.00','1419007325','1419698528','4,5,6','1418646645','1','东方');
...
INSERT INTO ecm_mail_queue ( `queue_id`, `mail_to`, `mail_encoding`, `mail_subject`, `mail_body`, `priority`, `err_num`, `add_time`, `lock_expiry` ) VALUES  ('85','','utf-8','微信商城提醒:您有一个新订单需要处理','<p>\r\n<p>尊敬的蝌蚪的家:</p>\r\n<p>您的新订单号为1434913676，请尽快处理。</p>\r\n<p>总价:￥688.00顾客详细:<br>名字:张老师(手机:电话:12345678978)<br>物品清单:<li id=goods_name>HTC 8S（A620t）3G手机TD-SCDMA/GSM　数量:1　单价:￥688.00　商品编号:</li><br>收货地址:中国	贵州	黔南	罗甸县测试<br>配送方式:包邮<br />备注:<br />下单时间:2014-12-16 14:15</p>\r\n<p>查看订单详细信息请点击以下链接</p>\r\n<p><a href=\"http://www.a.com/index.php?app=seller_order&amp;act=view&amp;order_id=30\">http://www.a.com/index.php?app=seller_order&amp;act=view&amp;order_id=30</a></p>\r\n<p>查看您的订单列表管理页请点击以下链接</p>\r\n<p><a href=\"http://www.a.com/index.php?app=seller_order\">http://www.a.com/index.php?app=seller_order</a></p>\r\n<p>微信商城</p>\r\n<p style=\"text-align: right;\">2014-12-16 14:15</p>\r\n</p>','1','1','1418681758','1418681928');
INSERT INTO ecm_mail_queue ( `queue_id`, `mail_to`, `mail_encoding`, `mail_subject`, `mail_body`, `priority`, `err_num`, `add_time`, `lock_expiry` ) VALUES  ('83','kitty@126.com','utf-8','微信商城提醒:您的订单已生成','<p>尊敬的kitty:</p>\r\n<p style=\"padding-left: 30px;\">您在微信商城上下的订单已生成，订单号1434913676。</p>\r\n<p style=\"padding-left: 30px;\">查看订单详细信息请点击以下链接</p>\r\n<p style=\"padding-left: 30px;\"><a href=\"http://www.a.com/index.php?app=buyer_order&amp;act=view&amp;order_id=30\">http://www.a.com/index.php?app=buyer_order&amp;act=view&amp;order_id=30</a></p>\r\n<p style=\"text-align: right;\">微信商城</p>\r\n<p style=\"text-align: right;\">2014-12-16 14:15</p>','1','1','1418681758','1418681928');
INSERT INTO ecm_mail_queue ( `queue_id`, `mail_to`, `mail_encoding`, `mail_subject`, `mail_body`, `priority`, `err_num`, `add_time`, `lock_expiry` ) VALUES  ('84','123456@qq.com','utf-8','微信商城提醒:您有一个新订单需要处理','<p>\r\n<p>尊敬的蝌蚪的家:</p>\r\n<p>您的新订单号为1434913676，请尽快处理。</p>\r\n<p>总价:￥688.00顾客详细:<br>名字:张老师(手机:电话:12345678978)<br>物品清单:<li id=goods_name>HTC 8S（A620t）3G手机TD-SCDMA/GSM　数量:1　单价:￥688.00　商品编号:</li><br>收货地址:中国	贵州	黔南	罗甸县测试<br>配送方式:包邮<br />备注:<br />下单时间:2014-12-16 14:15</p>\r\n<p>查看订单详细信息请点击以下链接</p>\r\n<p><a href=\"http://www.a.com/index.php?app=seller_order&amp;act=view&amp;order_id=30\">http://www.a.com/index.php?app=seller_order&amp;act=view&amp;order_id=30</a></p>\r\n<p>查看您的订单列表管理页请点击以下链接</p>\r\n<p><a href=\"http://www.a.com/index.php?app=seller_order\">http://www.a.com/index.php?app=seller_order</a></p>\r\n<p>微信商城</p>\r\n<p style=\"text-align: right;\">2014-12-16 14:15</p>\r\n</p>','1','1','1418681758','1418681928');
...
CREATE TABLE ecm_member (
  ...
  feed_config text,
  uin int(10) DEFAULT '0',
  parentid int(10) DEFAULT '0',
  user_level tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0:普通会员 1:高级会员 2:VIP会员',
  from_weixin tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0:是 1:否',
  wx_openid varchar(2000) DEFAULT NULL,
  wx_nickname varchar(500) DEFAULT NULL,
  wx_city varchar(500) DEFAULT NULL,
  wx_country varchar(500) DEFAULT NULL,
  wx_province varchar(500) DEFAULT NULL,
  wx_language varchar(500) DEFAULT NULL,
  wx_headimgurl varchar(1000) DEFAULT NULL,
  wx_subscribe_time int(10) unsigned NOT NULL DEFAULT '0',
  wx_id int(10) unsigned NOT NULL,
  from_public tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0:来自带参数二维码1:来自扫描公众号二维码  ',
  PRIMARY KEY (user_id),
  KEY user_name (user_name(333)),
  KEY email (email),
  KEY outer_id (outer_id)
) ENGINE=MyISAM;
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('1','admin','admin@qq.com','7fef6171469e80d32c0559f88b377245','','0',null,null,null,'','',null,null,null,'1388016632','1418683821','127.0.0.1','132','0','','0',null,'','13','15','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('2','seller','123456@qq.com','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1388031020','1418595243','127.0.0.1','60','0',null,'0',null,'','10','11','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('3','buyer','123456@qq.com','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1388031042','1415041777','127.0.0.1','29','0',null,'0',null,'','15',null,'0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('4','kitty','kitty@126.com','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1417904183','1418681721','127.0.0.1','10','0',null,'0',null,'','14',null,'0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('5','keke','123@qfd.com','e10adc3949ba59abbe56e057f20f883e','小额','0',null,null,null,'','',null,null,null,'1417906999','1417923055','111.161.30.96','12','0',null,'0',null,'','16',null,'0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('6','wode','adfas@afda.com','e10adc3949ba59abbe56e057f20f883e','kafa ','0',null,null,null,'','',null,null,null,'1417907320',null,null,'0','0',null,'0',null,'','12',null,'0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('7','weining','1164023517@qq.con','9cbf8a4dcb8e30682b927f352d6559a0',null,'0',null,null,null,null,null,null,null,null,'1417909961','1418340324','60.208.212.161','3','0',null,'0',null,'','18',null,'0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('8','xiaozu','zzzz@ddd.cn','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1417916601','1417916601','112.232.9.76','1','0',null,'0',null,'','21',null,'0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('9','15668333567','763665751@qq.com','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1417918910','1417918910','112.232.9.76','1','0',null,'0',null,'',null,null,'0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('10','222','12345@qq.com','e10adc3949ba59abbe56e057f20f883e','sfas','0',null,null,null,'','',null,null,null,'1417995633',null,null,'0','0',null,'0',null,'','55','55','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('11','sfsaf','12@4.cm','e10adc3949ba59abbe56e057f20f883e','sfaf','0',null,null,null,'','',null,null,null,'1417995684',null,null,'0','0',null,'0',null,'','18','19','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('12','yangxiuwei','12@12.cn','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1418009696','1418670706','127.0.0.1','9','0',null,'0',null,'','0','0','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('13','yangxiuwei1','1@1.cn','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1418011256','1418011256','127.0.0.1','1','0',null,'0',null,'','0','100','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('14','yangxiuwei11','1@1.cn','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1418012121','1418012121','127.0.0.1','1','0',null,'0',null,'','0','58','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('15','ffsdf','1@1.cn','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1418012179','1418012179','127.0.0.1','1','0',null,'0',null,'','0','56','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('16','fsdafasf','1@1.cn','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1418012227','1418012227','127.0.0.1','1','0',null,'0',null,'','0','57','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('17','555','1@1.cn','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1418012352','1418012352','127.0.0.1','1','0',null,'0',null,'','0','60','0','0','','','','','','','','0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('33','oJP7Rt7zs0vBqkp-VNtg7et_zEVc','','fd894139580e71c03722f74da0db4497',null,'1',null,null,null,null,null,null,null,null,'1418355790','1418327133','222.73.76.253','2','0',null,'0',null,null,'0','0','0','1','oJP7Rt7zs0vBqkp-VNtg7et_zEVc','靳灿博','鹤岗','中国','黑龙江','zh_CN','http://wx.qlogo.cn/mmopen/zNsFJyIuL0GKypCaVIsasfhnYrcFrl2icXmpDCibY3XsV7h7THdF1C9w7yn8iab1bzGFYaqYcNlgnFs0bhaiahALevxviaC9r3TPU/0','1418355803','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('31','oJP7Rt5lsefjstJ5MkAobIig7uGE','','69ed68e218cb12b679ec47666099b9d0',null,'1',null,null,null,null,null,null,null,null,'1418354514','1418348553','60.208.212.161','4','0',null,'0',null,null,'0','16','0','1','oJP7Rt5lsefjstJ5MkAobIig7uGE','卫宁+倍全','济南','中国','山东','zh_CN','http://wx.qlogo.cn/mmopen/XFJ8HdGGwGCVcqTSGoxDxAwhVvuf6K7YReicyUHMBtUHrtexAv4LcTg8ldoQyIZAg5ElZL5lU7Nfrw7oEhYziaZRQibxCrV1ibib3/0','1418354527','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('34','tsst','1417786233@qq.com','e10adc3949ba59abbe56e057f20f883e',null,'0',null,null,null,null,null,null,null,null,'1418340201','1418340201','210.51.19.2','1','0',null,'0',null,null,'0','0','0','0',null,null,null,null,null,null,null,'0','0','0');
INSERT INTO ecm_member ( `user_id`, `user_name`, `email`, `password`, `real_name`, `gender`, `birthday`, `phone_tel`, `phone_mob`, `im_qq`, `im_msn`, `im_skype`, `im_yahoo`, `im_aliww`, `reg_time`, `last_login`, `last_ip`, `logins`, `ugrade`, `portrait`, `outer_id`, `activation`, `feed_config`, `uin`, `parentid`, `user_level`, `from_weixin`, `wx_openid`, `wx_nickname`, `wx_city`, `wx_country`, `wx_province`, `wx_language`, `wx_headimgurl`, `wx_subscribe_time`, `wx_id`, `from_public` ) VALUES  ('35','oJP7Rtygl852LthdE0KfqD6stb_Y','','2e73d6a8b5c793467af03f83822bcd93',null,'1',null,null,null,null,null,null,null,null,'1418387088','1418358459','60.208.212.161','1','0',null,'0',null,null,'0','18','0','1','oJP7Rtygl852LthdE0KfqD6stb_Y','思创佰锐','济南','中国','山东','zh_CN','http://wx.qlogo.cn/mmopen/Xq6hfELloZ5l9LmA2c99P3bt01FGZIZ1dJ3a6pegLlIQ1GGqSvG6CItpvlc6qosaibDQCHstL7libiaTUxibl0gstF3W6Aic0ibZ3g/0','1418387102','28','0');
...
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('3','0','4','','您收到了 “超级店铺” 发送来的优惠券 \r\n 优惠金额：100.00 \r\n有效期：2014-12-07 至2014-12-31 \r\n优惠券号码：000000014996 \r\n使用条件：购物满 100.00 即可使用 \r\n店铺地址：[url=http://wap.bqmart.cn/index.php?app=store&amp;id=2]超级店铺[/url]','1417904233','1417904233','1','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('4','0','4','','您收到了 “超级店铺” 发送来的优惠券 \r\n 优惠金额：100.00 \r\n有效期：2014-12-07 至2014-12-31 \r\n优惠券号码：000000025943 \r\n使用条件：购物满 100.00 即可使用 \r\n店铺地址：[url=http://wap.bqmart.cn/index.php?app=store&amp;id=2]超级店铺[/url]','1417904951','1417904951','1','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('5','0','2','','您好,您申请秒杀的商品(\"海泉 野生苹果 新品上架 馈赠佳品 有糖心哦~\")已经通过审核','1417919450','1417919450','0','0','3');
...
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('9','0','3','','您收到了 “蝌蚪的家” 发送来的红包 \r\n 优惠金额：100.00 \r\n有效期：2014-12-07 至2014-12-31 \r\n红包号码：000000137436 \r\n使用条件：购物满 100.00 即可使用 \r\n店铺地址：[url=http://www.a.com/index.php?app=store&amp;id=2]蝌蚪的家[/url]','1418236997','1418236997','1','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('10','0','12','','您收到了 “蝌蚪的家” 发送来的红包 \r\n 优惠金额：100.00 \r\n有效期：2014-12-07 至2014-12-31 \r\n红包号码：000000146426 \r\n使用条件：购物满 100.00 即可使用 \r\n店铺地址：[url=http://www.a.com/index.php?app=store&amp;id=2]蝌蚪的家[/url]','1418236997','1418236997','1','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('11','0','3','','您收到了 “蝌蚪的家” 发送来的红包 \r\n 优惠金额：23.00 \r\n有效期：2014-12-11 至2014-12-30 \r\n红包号码：000000156693 \r\n使用条件：购物满 3.00 即可使用 \r\n店铺地址：[url=http://www.a.com/index.php?app=store&amp;id=2]蝌蚪的家[/url]','1418237682','1418237682','1','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('12','0','12','','您收到了 “蝌蚪的家” 发送来的红包 \r\n 优惠金额：23.00 \r\n有效期：2014-12-11 至2014-12-30 \r\n红包号码：000000166892 \r\n使用条件：购物满 3.00 即可使用 \r\n店铺地址：[url=http://www.a.com/index.php?app=store&amp;id=2]蝌蚪的家[/url]','1418237682','1418237682','1','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('13','0','2','','您收到了 “蝌蚪的家” 发送来的红包 \r\n 优惠金额：10.00 \r\n有效期：2014-12-11 至2014-12-31 \r\n红包号码：000003204913 \r\n使用条件：购物满 5.00 即可使用 \r\n店铺地址：[url=http://www.a.com/index.php?app=store&amp;id=2]蝌蚪的家[/url]','1418246984','1418246984','0','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('14','0','3','','您收到了 “蝌蚪的家” 发送来的红包 \r\n 优惠金额：10.00 \r\n有效期：2014-12-11 至2014-12-31 \r\n红包号码：000003215118 \r\n使用条件：购物满 5.00 即可使用 \r\n店铺地址：[url=http://www.a.com/index.php?app=store&amp;id=2]蝌蚪的家[/url]','1418246984','1418246984','1','0','3');
INSERT INTO ecm_message ( `msg_id`, `from_id`, `to_id`, `title`, `content`, `add_time`, `last_update`, `new`, `parent_id`, `status` ) VALUES  ('15','0','12','','您收到了 “蝌蚪的家” 发送来的红包 \r\n 优惠金额：10.00 \r\n有效期：2014-12-11 至2014-12-31 \r\n红包号码：000003225240 \r\n使用条件：购物满 5.00 即可使用 \r\n店铺地址：[url=http://www.a.com/index.php?app=store&amp;id=2]蝌蚪的家[/url]','1418246984','1418246984','1','0','3');
...
INSERT INTO ecm_my_money ( `id`, `add_time`, `mibao_id`, `mibao_sn`, `user_id`, `user_name`, `bank_sn`, `bank_name`, `bank_username`, `bank_add`, `zf_pass`, `pass_tw`, `pass_hd`, `jifen_z`, `jifen`, `money_dj`, `money` ) VALUES  ('8','1418038496','0',null,'12','yangxiuwei',null,null,null,null,'e10adc3949ba59abbe56e057f20f883e',null,null,'0','0','0.00','0.00');
INSERT INTO ecm_my_money ( `id`, `add_time`, `mibao_id`, `mibao_sn`, `user_id`, `user_name`, `bank_sn`, `bank_name`, `bank_username`, `bank_add`, `zf_pass`, `pass_tw`, `pass_hd`, `jifen_z`, `jifen`, `money_dj`, `money` ) VALUES  ('9','1418040056','0',null,'13','yangxiuwei1',null,null,null,null,'e10adc3949ba59abbe56e057f20f883e',null,null,'0','0','0.00','0.00');
INSERT INTO ecm_my_money ( `id`, `add_time`, `mibao_id`, `mibao_sn`, `user_id`, `user_name`, `bank_sn`, `bank_name`, `bank_username`, `bank_add`, `zf_pass`, `pass_tw`, `pass_hd`, `jifen_z`, `jifen`, `money_dj`, `money` ) VALUES  ('10','1418040921','0',null,'14','yangxiuwei11',null,null,null,null,'e10adc3949ba59abbe56e057f20f883e',null,null,'0','0','0.00','0.00');
INSERT INTO ecm_my_money ( `id`, `add_time`, `mibao_id`, `mibao_sn`, `user_id`, `user_name`, `bank_sn`, `bank_name`, `bank_username`, `bank_add`, `zf_pass`, `pass_tw`, `pass_hd`, `jifen_z`, `jifen`, `money_dj`, `money` ) VALUES  ('11','1418040979','0',null,'15','ffsdf',null,null,null,null,'e10adc3949ba59abbe56e057f20f883e',null,null,'0','0','0.00','0.00');
INSERT INTO ecm_my_money ( `id`, `add_time`, `mibao_id`, `mibao_sn`, `user_id`, `user_name`, `bank_sn`, `bank_name`, `bank_username`, `bank_add`, `zf_pass`, `pass_tw`, `pass_hd`, `jifen_z`, `jifen`, `money_dj`, `money` ) VALUES  ('12','1418041027','0',null,'16','fsdafasf',null,null,null,null,'e10adc3949ba59abbe56e057f20f883e',null,null,'0','0','0.00','0.00');
INSERT INTO ecm_my_money ( `id`, `add_time`, `mibao_id`, `mibao_sn`, `user_id`, `user_name`, `bank_sn`, `bank_name`, `bank_username`, `bank_add`, `zf_pass`, `pass_tw`, `pass_hd`, `jifen_z`, `jifen`, `money_dj`, `money` ) VALUES  ('13','1418041152','0',null,'17','555',null,null,null,null,'e10adc3949ba59abbe56e057f20f883e',null,null,'0','0','0.00','0.00');
...
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('1','1335948628','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1388043112','1','支付宝','','alipay','1335948628',null,'',null,null,'0','32.00','0.00','32.10','0','0','0','','0','15');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('2','1430545601','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1414945788',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','14');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('3','1430582838','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1414946790','5','支付宝网银','','alipay_bank','1430582838',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('4','1430692306','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415005198',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('5','1430682804','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415010011',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('6','1430601794','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415020942',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('7','1430675558','material','normal','2','超级店铺','3','buyer','123456@qq.com','0','1415022647',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('8','1430685606','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415022698',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('9','1430647270','material','normal','2','超级店铺','3','buyer','123456@qq.com','0','1415023057',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('10','1430696709','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415023120',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('11','1430673382','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415023309',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('12','1430675012','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415023782',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('13','1430674771','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415024003',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('14','1430661529','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415024686',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('15','1430639462','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415025439',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('16','1430673793','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415028434',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('17','1430623401','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415028502',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('18','1430628151','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415031057',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('19','1430676032','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415031109',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('20','1430604002','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415037899',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('21','1430647384','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415038349',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('22','1430602088','material','normal','2','超级店铺','3','buyer','123456@qq.com','0','1415038392',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('23','1430695307','material','normal','2','超级店铺','3','buyer','123456@qq.com','11','1415038572',null,null,'','','',null,'',null,null,'0','0.10','0.00','0.10','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('24','1430676055','material','normal','2','超级店铺','3','buyer','123456@qq.com','0','1415039029','4','支付宝免签接口','','alipayfree','',null,'',null,null,'0','88.00','0.00','88.00','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('25','1434051293','material','normal','2','超级店铺','4','kitty','kitty@126.com','0','1417904627',null,null,'','','',null,'',null,null,'0','123.50','100.00','23.50','0','0','0','','0','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('26','1434022188','material','normal','2','蝌蚪的家','4','kitty','kitty@126.com','0','1417913360',null,null,'','','',null,'',null,null,'0','16666.00','0.00','16666.00','0','0','0','快拿来','1','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('27','1434003921','material','normal','5','粉砂的记忆','4','kitty','kitty@126.com','11','1417913860',null,null,'','','',null,'',null,null,'0','500.00','0.00','550.00','0','0','0','','1','0');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('28','1434135197','material','normal','2','蝌蚪的家','17','555','1@1.cn','11','1418013481',null,null,'','','',null,'',null,null,'0','1588.00','0.00','1588.00','0','0','0','ffdf','0','60');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('29','1434107420','material','normal','2','蝌蚪的家','16','fsdafasf','1@1.cn','11','1418013559',null,null,'','','',null,'',null,null,'0','1549.00','0.00','1549.00','0','0','0','','0','57');
INSERT INTO ecm_order ( `order_id`, `order_sn`, `type`, `extension`, `seller_id`, `seller_name`, `buyer_id`, `buyer_name`, `buyer_email`, `status`, `add_time`, `payment_id`, `payment_name`, `payment_bank`, `payment_code`, `out_trade_sn`, `pay_time`, `pay_message`, `ship_time`, `invoice_no`, `finished_time`, `goods_amount`, `discount`, `order_amount`, `evaluation_status`, `evaluation_time`, `anonymous`, `postscript`, `pay_alter`, `uin` ) VALUES  ('30','1434913676','material','normal','2','蝌蚪的家','4','kitty','kitty@126.com','11','1418681758','4','支付宝免签接口','','alipayfree','',null,'',null,null,'0','688.00','0.00','688.00','0','0','0','','0','0');
...
INSERT INTO ecm_order_extm ( `order_id`, `consignee`, `region_id`, `region_name`, `address`, `zipcode`, `phone_tel`, `phone_mob`, `shipping_id`, `shipping_name`, `shipping_fee` ) VALUES  ('28','yafa','18','中国	北京	北京	平谷区','fafaf','','15668333567','','1','包邮','0.00');
INSERT INTO ecm_order_extm ( `order_id`, `consignee`, `region_id`, `region_name`, `address`, `zipcode`, `phone_tel`, `phone_mob`, `shipping_id`, `shipping_name`, `shipping_fee` ) VALUES  ('29','fasfds','2850','中国	天津	天津	河北区','fdsfds','','15888999568','15888999568','1','包邮','0.00');
INSERT INTO ecm_order_extm ( `order_id`, `consignee`, `region_id`, `region_name`, `address`, `zipcode`, `phone_tel`, `phone_mob`, `shipping_id`, `shipping_name`, `shipping_fee` ) VALUES  ('30','张老师','714','中国	贵州	黔南	罗甸县','测试','','12345678978','','1','包邮','0.00');
...
CREATE TABLE ecm_order_goods (
  ...
  cuxiao_id int(10) DEFAULT NULL,
  PRIMARY KEY (rec_id),
  KEY order_id (order_id,goods_id)
) ENGINE=MyISAM;
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('1','1','18','沙洲优黄花开富贵480ml/瓶','18','','32.00','1','data/files/store_2/goods_166/small_201312262109269656.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('2','2','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('3','3','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('4','4','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('5','5','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('6','6','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('7','7','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('8','8','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('9','9','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('10','10','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('11','11','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('12','12','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('13','13','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('14','14','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('15','15','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('16','16','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('17','17','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('18','18','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('19','19','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('20','20','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('21','21','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('22','22','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('23','23','99','测试商品','99','颜色:红色 尺码:S','0.10','1','data/files/store_2/goods_123/small_201406260258439769.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('24','24','87','道尔顿PF前置折叠棉滤芯','87','','88.00','1','data/files/store_2/goods_86/small_201312262258066317.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('25','25','12','杰记 国产 红肉 新鲜 红心蜜柚','12','','28.50','1','data/files/store_2/goods_144/small_201312262102246687.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('26','25','20','口子窖白酒（五年）46度 400ml','20','','95.00','1','data/files/store_2/goods_51/small_201312262110515808.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('27','26','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('28','26','12','杰记 国产 红肉 新鲜 红心蜜柚','12','','28.50','1','data/files/store_2/goods_144/small_201312262102246687.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('29','27','100','测试商品','103','','125.00','1','data/files/store_5/goods_12/small_201412071530126470.png','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('30','28','98','酷派(Coolpad)8730 3G手机 TD-SCDMA/GSM','98','','1588.00','1','data/files/store_2/goods_107/small_201312262308271759.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('31','29','97','三星（SAMSUNG）I8558 3G手机 TD-SCDMA/GSM 双卡双待','97','','1549.00','1','data/files/store_2/goods_27/small_201312262307078496.jpg','0','','0','1',null);
INSERT INTO ecm_order_goods ( `rec_id`, `order_id`, `goods_id`, `goods_name`, `spec_id`, `specification`, `price`, `quantity`, `goods_image`, `evaluation`, `comment`, `credit_value`, `is_valid`, `cuxiao_id` ) VALUES  ('32','30','95','HTC 8S（A620t）3G手机TD-SCDMA/GSM','95','','688.00','1','data/files/store_2/goods_134/small_201312262305341913.jpg','0','','0','1',null);
...
DROP TABLE IF EXISTS ecm_pattern_a;
CREATE TABLE ecm_pattern_a (
  pa_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '组合A编号',
  pa_name varchar(500) NOT NULL COMMENT '促销名称',
  goods_id int(11) unsigned NOT NULL COMMENT '商品编号',
  goods_sn varchar(255) NOT NULL COMMENT '商品条码',
  goods_name varchar(500) NOT NULL COMMENT '商品名称',
  original_price decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '商品原价',
  promotion_price decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '商品促销价',
  promotion_num int(11) NOT NULL COMMENT '促销数量',
  p_type int(2) DEFAULT NULL,
  cuxiao_id int(11) DEFAULT NULL,
  PRIMARY KEY (pa_id)
) ENGINE=MyISAM;
INSERT INTO ecm_pattern_a ( `pa_id`, `pa_name`, `goods_id`, `goods_sn`, `goods_name`, `original_price`, `promotion_price`, `promotion_num`, `p_type`, `cuxiao_id` ) VALUES  ('1','测试促销1','101','','测试商品','10.00','8.00','2','1','1');
INSERT INTO ecm_pattern_a ( `pa_id`, `pa_name`, `goods_id`, `goods_sn`, `goods_name`, `original_price`, `promotion_price`, `promotion_num`, `p_type`, `cuxiao_id` ) VALUES  ('2','测试促销1','97','','三星手机','1549.00','100.00','1','1','1');
DROP TABLE IF EXISTS ecm_pattern_b;
CREATE TABLE ecm_pattern_b (
  pb_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '组合B编号',
  pb_name varchar(500) NOT NULL COMMENT '促销名称',
  goods_id int(11) unsigned NOT NULL COMMENT '商品编号',
  goods_sn varchar(255) NOT NULL COMMENT '商品条码',
  goods_name varchar(500) NOT NULL COMMENT '商品名称',
  original_price decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '商品原价',
...
DROP TABLE IF EXISTS ecm_promotion_sale;
CREATE TABLE ecm_promotion_sale (
  ps_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '编号，主键 自增',
  trade_sn varchar(255) NOT NULL COMMENT '交易流水号',
  promotion_id int(11) unsigned NOT NULL COMMENT '促销编号',
  goods_id int(11) unsigned NOT NULL COMMENT '商品编号',
  goods_sn varchar(255) NOT NULL COMMENT '商品条码',
  goods_name varchar(500) NOT NULL COMMENT '商品名称',
  sale_price decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '销售单价',
  sale_num int(11) unsigned NOT NULL COMMENT '销售数量',
  sale_time int(10) unsigned NOT NULL COMMENT '销售时间',
  user_id int(11) unsigned NOT NULL COMMENT '用户编号',
  session_id varchar(500) NOT NULL COMMENT 'SESSIONID',
  sale_flag varchar(500) NOT NULL COMMENT '销售标识',
  store_id int(10) DEFAULT NULL,
  PRIMARY KEY (ps_id)
) ENGINE=MyISAM;
INSERT INTO ecm_promotion_sale ( `ps_id`, `trade_sn`, `promotion_id`, `goods_id`, `goods_sn`, `goods_name`, `sale_price`, `sale_num`, `sale_time`, `user_id`, `session_id`, `sale_flag`, `store_id` ) VALUES  ('9','','1','101','695072785132','测试商品','8.00','2','0','12','cb7dc47a8668d1854e448ca99dff25fd','0','2');
INSERT INTO ecm_promotion_sale ( `ps_id`, `trade_sn`, `promotion_id`, `goods_id`, `goods_sn`, `goods_name`, `sale_price`, `sale_num`, `sale_time`, `user_id`, `session_id`, `sale_flag`, `store_id` ) VALUES  ('10','','1','97','','三星（SAMSUNG）I8558 3G手机 TD-SCDMA/GSM 双卡双待','100.00','1','0','12','cb7dc47a8668d1854e448ca99dff25fd','0','2');
...
DROP TABLE IF EXISTS ecm_schedule;
CREATE TABLE ecm_schedule (
  schedule_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '档期编号',
  schedule_name varchar(500) NOT NULL COMMENT '档期名称',
  start_time int(10) unsigned NOT NULL COMMENT '档期开始时间',
  end_time int(10) unsigned NOT NULL COMMENT '档期结束时间',
  add_time int(10) unsigned NOT NULL COMMENT '录入时间',
  schedule_state tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '档期状态 1：未启用 2：启用',
  operate_person varchar(255) NOT NULL COMMENT '操作人',
  PRIMARY KEY (schedule_id)
) ENGINE=MyISAM;
INSERT INTO ecm_schedule ( `schedule_id`, `schedule_name`, `start_time`, `end_time`, `add_time`, `schedule_state`, `operate_person` ) VALUES  ('12','东来的华东a','1418949633','1419036033','1418546444','2','花子a');
INSERT INTO ecm_schedule ( `schedule_id`, `schedule_name`, `start_time`, `end_time`, `add_time`, `schedule_state`, `operate_person` ) VALUES  ('13','开恶的的东西aa','1418748097','1419525701','1418546510','2','我的嘎嘎aa');
INSERT INTO ecm_schedule ( `schedule_id`, `schedule_name`, `start_time`, `end_time`, `add_time`, `schedule_state`, `operate_person` ) VALUES  ('14','剋来的格式的','1418978525','1419669728','1418546540','1','丽娜');
...
INSERT INTO ecm_sessions ( `sesskey`, `expiry`, `userid`, `adminid`, `ip`, `data`, `is_overflow` ) VALUES  ('236c2a5a83e19b2a541f98108da0f9ec','1418686136','0','0','127.0.0.1','','1');
INSERT INTO ecm_sessions ( `sesskey`, `expiry`, `userid`, `adminid`, `ip`, `data`, `is_overflow` ) VALUES  ('cb7dc47a8668d1854e448ca99dff25fd','1418685640','0','0','127.0.0.1','user_info|a:6:{s:7:\"user_id\";s:2:\"12\";s:9:\"user_name\";s:10:\"yangxiuwei\";s:8:\"reg_time\";s:10:\"1418009696\";s:10:\"last_login\";s:10:\"1418663976\";s:7:\"last_ip\";s:9:\"127.0.0.1\";s:8:\"store_id\";N;}','0');
INSERT INTO ecm_sessions ( `sesskey`, `expiry`, `userid`, `adminid`, `ip`, `data`, `is_overflow` ) VALUES  ('c2f9a31f08908b1974aa240ed9595eaf','1418682990','0','0','127.0.0.1','admin_info|a:5:{s:7:\"user_id\";s:1:\"1\";s:9:\"user_name\";s:5:\"admin\";s:8:\"reg_time\";s:10:\"1388016632\";s:10:\"last_login\";s:10:\"1418618236\";s:7:\"last_ip\";s:9:\"127.0.0.1\";}','0');
...
INSERT INTO ecm_sessions_data ( `sesskey`, `expiry`, `data` ) VALUES  ('236c2a5a83e19b2a541f98108da0f9ec','1418686136','user_info|a:6:{s:7:\"user_id\";s:1:\"4\";s:9:\"user_name\";s:5:\"kitty\";s:8:\"reg_time\";s:10:\"1417904183\";s:10:\"last_login\";s:10:\"1417916302\";s:7:\"last_ip\";s:12:\"112.232.9.76\";s:8:\"store_id\";N;}admin_info|a:5:{s:7:\"user_id\";s:1:\"1\";s:9:\"user_name\";s:5:\"admin\";s:8:\"reg_time\";s:10:\"1388016632\";s:10:\"last_login\";s:10:\"1418683754\";s:7:\"last_ip\";s:9:\"127.0.0.1\";}');
...
CREATE TABLE ecm_store (
  ...
  area_peisong varchar(500) DEFAULT NULL COMMENT '配送区域',
  power_coupon int(1) NOT NULL DEFAULT '0' COMMENT '红包权限',
...
INSERT INTO ecm_store ( `store_id`, `store_name`, `owner_name`, `owner_card`, `region_id`, `region_name`, `address`, `zipcode`, `tel`, `sgrade`, `apply_remark`, `credit_value`, `praise_rate`, `domain`, `state`, `close_reason`, `add_time`, `end_time`, `certification`, `sort_order`, `recommended`, `theme`, `store_banner`, `store_logo`, `description`, `image_1`, `image_2`, `image_3`, `im_qq`, `im_ww`, `im_msn`, `hot_search`, `business_scope`, `online_service`, `hotline`, `pic_slides`, `pic_slides_wap`, `enable_groupbuy`, `enable_radar`, `waptheme`, `is_open_pay`, `area_peisong`, `power_coupon` ) VALUES  ('2','蝌蚪的家','小蝌蚪','380302198625250123','7','中国	北京	北京	朝阳区','测试地址','241141','88888888','1','','0','0.00','','1','','1388031275','1609228800','autonym,material','65535','1','default|default',null,null,'','','','','540616918','阿哩木','','','','','','','{\"1\":{\"url\":\"data/files/store_2/pic_slides_wap/pic_slides_wap_1.jpg\",\"link\":\"#\"},\"2\":{\"url\":\"data/files/store_2/pic_slides_wap/pic_slides_wap_2.jpg\",\"link\":\"#\"},\"3\":{\"url\":\"data/files/store_2/pic_slides_wap/pic_slides_wap_3.jpg\",\"link\":\"#\"}}','0','1','default13|default','1',',45,51,7','0');
INSERT INTO ecm_store ( `store_id`, `store_name`, `owner_name`, `owner_card`, `region_id`, `region_name`, `address`, `zipcode`, `tel`, `sgrade`, `apply_remark`, `credit_value`, `praise_rate`, `domain`, `state`, `close_reason`, `add_time`, `end_time`, `certification`, `sort_order`, `recommended`, `theme`, `store_banner`, `store_logo`, `description`, `image_1`, `image_2`, `image_3`, `im_qq`, `im_ww`, `im_msn`, `hot_search`, `business_scope`, `online_service`, `hotline`, `pic_slides`, `pic_slides_wap`, `enable_groupbuy`, `enable_radar`, `waptheme`, `is_open_pay`, `area_peisong`, `power_coupon` ) VALUES  ('5','粉砂的记忆','可科贸','3803021986252501238888','46','中国	安徽	巢湖	无为县','测试地址','241177','77777777','2','','0','0.00','','1','','1417907226','1609228800','autonym,material','65535','1','',null,null,null,'','','','','','','','','','','','','0','1','','0',',263,410,175','0');
...
INSERT INTO ecm_uploaded_file ( `file_id`, `store_id`, `file_type`, `file_size`, `file_name`, `file_path`, `add_time`, `belong`, `item_id` ) VALUES  ('110','2','image/jpeg','70738','1.jpg','data/files/store_2/goods_106/201412121551463018.jpg','1418341906','2','101');
...
INSERT INTO ecm_user_coupon ( `user_id`, `coupon_sn` ) VALUES  ('3','000000502913');
INSERT INTO ecm_user_coupon ( `user_id`, `coupon_sn` ) VALUES  ('12','000000404539');
...
DROP TABLE IF EXISTS ecm_wx_code;
CREATE TABLE ecm_wx_code (
  code_id int(11) unsigned NOT NULL AUTO_INCREMENT,
  code_title varchar(500) NOT NULL,
  wx_id int(11) unsigned NOT NULL,
  is_used tinyint(1) NOT NULL DEFAULT '1' COMMENT '0:失效,1:启用',
  code_img varchar(500) NOT NULL,
  uin int(10) unsigned NOT NULL COMMENT '本人推荐号,唯一不重复',
  user_id int(10) unsigned NOT NULL,
  user_level tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0:普通会员,1:高级会员,2:VIP会员',
  user_name varchar(2000) NOT NULL,
  PRIMARY KEY (code_id)
) ENGINE=MyISAM;
INSERT INTO ecm_wx_code ( `code_id`, `code_title`, `wx_id`, `is_used`, `code_img`, `uin`, `user_id`, `user_level`, `user_name` ) VALUES  ('33','促销活动','28','1','https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQHa8DoAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL2cwekRWc2ZsZjFZR0EwR3FGbURnAAIE_TCIVAMEAAAAAA==','10','2','0','seller');
INSERT INTO ecm_wx_code ( `code_id`, `code_title`, `wx_id`, `is_used`, `code_img`, `uin`, `user_id`, `user_level`, `user_name` ) VALUES  ('34','集体活动','28','1','https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQFb8ToAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL09VejQ1eFRsVUZZcDItc1BMV0RnAAIEBr2IVAMEAAAAAA==','16','5','0','keke');
INSERT INTO ecm_wx_code ( `code_id`, `code_title`, `wx_id`, `is_used`, `code_img`, `uin`, `user_id`, `user_level`, `user_name` ) VALUES  ('35','双十二策划','28','1','https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQEh8ToAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL1FVejhQNi1sVWxZcndJUFJLV0RnAAIEiFaIVAMEAAAAAA==','13','1','0','admin');
INSERT INTO ecm_wx_code ( `code_id`, `code_title`, `wx_id`, `is_used`, `code_img`, `uin`, `user_id`, `user_level`, `user_name` ) VALUES  ('36','策划标题','28','1','https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQED8ToAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL04wekFWbVBsZVZZQUUtV3ZGV0RnAAIEXb2IVAMEAAAAAA==','14','4','0','kitty');
INSERT INTO ecm_wx_code ( `code_id`, `code_title`, `wx_id`, `is_used`, `code_img`, `uin`, `user_id`, `user_level`, `user_name` ) VALUES  ('39','心花怒放','28','1','https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQHz8DoAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL0JVeVhRTmpsTDFaV2pNZTRRbURnAAIELsyIVAMEAAAAAA==','12','6','0','wode');
INSERT INTO ecm_wx_code ( `code_id`, `code_title`, `wx_id`, `is_used`, `code_img`, `uin`, `user_id`, `user_level`, `user_name` ) VALUES  ('40','我的高拉是哦好哦','28','1','https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQH98DoAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL0owenRoUFhsUVZZNFJfVm9PR0RnAAIEMbKKVAMEAAAAAA==','18','11','0','sfsaf');
INSERT INTO ecm_wx_code ( `code_id`, `code_title`, `wx_id`, `is_used`, `code_img`, `uin`, `user_id`, `user_level`, `user_name` ) VALUES  ('41','圣诞节测试','28','1','https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQF08joAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL0QweU95QTdsSTFaYTJNMGxXMkRnAAIEgZyLVAMEAAAAAA==','15','3','0','buyer');
DROP TABLE IF EXISTS ecm_wx_code_keywords;
CREATE TABLE ecm_wx_code_keywords (
  keywords_id int(11) unsigned NOT NULL AUTO_INCREMENT,
  w_id int(11) unsigned NOT NULL,
  code_id int(11) unsigned NOT NULL,
  keywords_name varchar(500) NOT NULL,
  keywords_rule tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:全匹配,1:模糊匹配',
  PRIMARY KEY (keywords_id)
) ENGINE=MyISAM;
DROP TABLE IF EXISTS ecm_wx_code_person;
CREATE TABLE ecm_wx_code_person (
  person_id int(11) unsigned NOT NULL AUTO_INCREMENT,
  w_id int(11) unsigned NOT NULL,
  code_id int(11) unsigned NOT NULL,
  uin int(10) unsigned NOT NULL COMMENT '本人推荐号',
  user_id int(10) unsigned NOT NULL,
  user_openid varchar(500) NOT NULL COMMENT '唯一不能重复',
  PRIMARY KEY (person_id)
) ENGINE=MyISAM;
DROP TABLE IF EXISTS ecm_wx_code_reply;
CREATE TABLE ecm_wx_code_reply (
  reply_id int(11) unsigned NOT NULL AUTO_INCREMENT,
  w_id int(11) unsigned NOT NULL,
  code_id int(11) unsigned NOT NULL,
  reply_type tinyint(1) NOT NULL COMMENT '0:文本,1:图片,2:语音,3:图文',
  PRIMARY KEY (reply_id)
) ENGINE=MyISAM;
DROP TABLE IF EXISTS ecm_wx_pub_config;
CREATE TABLE ecm_wx_pub_config (
...
INSERT INTO ecm_wx_pub_config ( `wx_id`, `url`, `token`, `appid`, `appsecret`, `account` ) VALUES  ('9','http://www.a.com/index.php?app=wx_deal&randid=df12ecd077efc8c23881028604dbb8cc','806fSvU2','weqwreqwoewqfioeitjei','ewqreqw8rqwrqwerqwrq','32345235');
INSERT INTO ecm_wx_pub_config ( `wx_id`, `url`, `token`, `appid`, `appsecret`, `account` ) VALUES  ('10','http://www.a.com/index.php?app=wx_deal&randid=d0b9a6a56ca7fd6ebad617bcda8365a6','akyr6KuT','54586416456','sdfadsftretrfewfew','werfewqoe5878');
INSERT INTO ecm_wx_pub_config ( `wx_id`, `url`, `token`, `appid`, `appsecret`, `account` ) VALUES  ('11','http://www.a.com/index.php?app=wx_deal&randid=9c4e6233c6d5ff637e7984152a3531d5','W5SYmk0C','werewfoosioew','23u2fj23f02939','i823035843020');
INSERT INTO ecm_wx_pub_config ( `wx_id`, `url`, `token`, `appid`, `appsecret`, `account` ) VALUES  ('12','http://www.a.com/index.php?app=wx_deal&randid=e816c635cad85a60fabd6b97b03cbcc9','ZafeYyyO','ewfweofwejqfjoioqew','232r2r24r32','320r340t534');
INSERT INTO ecm_wx_pub_config ( `wx_id`, `url`, `token`, `appid`, `appsecret`, `account` ) VALUES  ('13','http://www.a.com/index.php?app=wx_deal&randid=38ca89564b2259401518960f7a06f94b','Qfi6Cym1','erqwerfqwe32r','weqr43t4yt45y','ewrqwerp324r34');
INSERT INTO ecm_wx_pub_config ( `wx_id`, `url`, `token`, `appid`, `appsecret`, `account` ) VALUES  ('14','http://www.a.com/index.php?app=wx_deal&randid=03b264c595403666634ac75d828439bc','XQsakHyx','weqfqwefjq3eqw3','ftfg34tg45gy45','ewqr3q4tq4ftq34');
