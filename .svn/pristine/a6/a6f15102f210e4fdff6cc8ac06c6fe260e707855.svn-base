...
$config->APPID		= '208739';	//你的API Key，请自行申请
$config->APIKey		= '82596d938a154d4e8335892515e0125d';	//你的API Key，请自行申请
$config->SecretKey	= '5ca674b51cda4adf9883715f3ca099b5';	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

$config->redirecturi= 'http://www.513cc.com/includes/third/renren_api/accesstoken.php';//你的获取code的回调地址，也是accesstoken的回调地址
